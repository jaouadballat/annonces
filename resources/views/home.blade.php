...
<div class="product-item bg-light">
	<div class="card">
		<div class="thumb-content">
			...
			<a href="">
				<img class="card-img-top img-fluid" src="{{ Storage::url('logo.jpg') }}">
			</a>
		</div>
		<div class="card-body">
...
<div class="product-item bg-light">
	<div class="card">
		<div class="thumb-content">
			<!-- <div class="price">$200</div> -->
			<a href="">
				<img class="card-img-top img-fluid" src="{{ Storage::url('logo.jpg') }}" alt="Card image cap">
			</a>
		</div>
		<div class="card-body">
    ...
    <div class="row">
      <div class="col-lg-3 col-md-7 offset-md-1 offset-lg-0">
        ...
        <div class="block about">
          <!-- footer logo -->
          <img src="{{ Storage::url('images/logo-footer.png') }}" alt="">
          <!-- description -->
